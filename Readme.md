...
# Parsing + Configuration Script – AP - GC Diafragma  - Rev. A

This **Parsing + Configuration** script is designed for the **AP - GC Diafragma ** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AP - GC Diafragma  Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AP - GC Diafragma ** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
